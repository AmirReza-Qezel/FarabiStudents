...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(185, 585);
			...
			this->socialSkilltb->TabIndex = 43;
			// 
			// Quantumtb
			// 
			...
			this->rocketsciencetb->TabIndex = 41;
			// 
			// mathtb
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	try
	{
			...
			if (this->Majortb->Text == "CE" || this->Majortb->Text == "IE")
			{
			  ...
			  if (System::Convert::ToSingle(this->mathtb->Text) < 0 || System::Convert::ToSingle(this->mathtb->Text) >= 20
				|| System::Convert::ToSingle(this->rocketsciencetb->Text) < 0 || System::Convert::ToSingle(this->rocketsciencetb->Text) >= 20
				|| System::Convert::ToSingle(this->biologytb->Text) < 0 || System::Convert::ToSingle(this->biologytb->Text) >= 20
				|| System::Convert::ToSingle(this->Physicstb->Text) < 0 || System::Convert::ToSingle(this->Physicstb->Text) >= 20
				|| System::Convert::ToSingle(this->Quantumtb->Text) < 0 || System::Convert::ToSingle(this->Quantumtb->Text) >= 20
				|| System::Convert::ToSingle(this->socialSkilltb->Text) < 0 || System::Convert::ToSingle(this->socialSkilltb->Text) >= 20)
			   {
				MessageBox::Show("Scores Should be Between 0.01 and 20", "Invalid inputs", MessageBoxButtons::OK);
			   }
			   else
			   {
				String^ s1 = this->mathtb->Text;
				String^ s2 = this->rocketsciencetb->Text;
				String^ s3 = this->biologytb->Text;
				String^ s4 = this->Physicstb->Text;
				String^ s5 = this->Quantumtb->Text;
				String^ s6 = this->socialSkilltb->Text;
				float math = System::Convert::ToSingle(s1);
				float rocketscience = System::Convert::ToSingle(s2);
				float biology = System::Convert::ToSingle(s3);
				float physics = System::Convert::ToSingle(s4);
				float quantumcalc = System::Convert::ToSingle(s5);
				float socialskill = System::Convert::ToSingle(s6);
				float sum = math + rocketscience + biology + physics + quantumcalc + socialskill;
				float totalScore = sum / 6;
				...
				sqlconn.Open();
				String^ query = "INSERT INTO dbo.Students (StudentID, FullName, Major, TotalScore) VALUES('" + this->IDtb->Text + "','" + this->Fullnametb->Text + "','" + this->Majortb->Text + "','" + totalScore + "');";
				...
				MessageBox::Show("Major should only be CE or IE", "Invalid inputs", MessageBoxButtons::OK);
	...
	{
		MessageBox::Show("Please insert valid data which is not currently available", "Invalid inputs", MessageBoxButtons::OK);
	}
}
};
}
